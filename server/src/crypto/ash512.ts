// ASH-512 Implementation using coordinate geometry concepts
// Based on research paper: "ASH-512: Design and implementation of cryptographic hash algorithm using co-ordinate geometry concepts"
